...
<div class="container py-5 d-flex justify-content-center">
    <div class="col-md-6 bg-white p-4 rounded shadow">
        <h3 class="mb-4 text-center text-primary">تعديل المنتج</h3>
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="T-Shirt" value="{{ old('name', $product->name) }}">
            ...
            <div class="mb-3 text-center">
                <input type="submit" value="تحديث المنتج" class="btn btn-primary px-4 py-2">
            </div>
        </form>
    </div>
</div>
